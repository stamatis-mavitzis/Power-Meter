...
// Green LED: ON only while no INA219/SD failure has occurred since boot.
// OLED status does not affect this LED.
#define SYSTEM_OK_LED 2

// Green LED: flashes after a successful measurement.
#define MEASUREMENT_OK_LED 3

// Red LED: latches ON after an invalid measurement, INA219 failure,
// or SD-card failure. It clears only after reset/power cycle.
