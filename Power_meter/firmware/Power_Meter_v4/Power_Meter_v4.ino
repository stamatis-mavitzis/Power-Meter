...
void setup() {
  ...
  // Show the combined device state on the D2 green LED.
...
void loop() {
  ...
  if (currentMillis - previousMillis >= MEASUREMENT_INTERVAL_MS) {
    ...
    // ==================================================
    //
    // The original program only tries to write while sdConnected
    // is true. If opening DATA.csv fails, SDLogger.cpp sets the
    // flag to false and prints a warning.
    // ==================================================
